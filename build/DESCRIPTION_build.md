...
The `build/` directory is used to store all files generated during the compilation process.  
It is **not part of the source code**, but rather the result of building it.
